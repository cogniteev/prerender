...
server.onPhantomPageCreate = function(req, res) {
    ...
    req.prerender.page.run(_this.options.blockedResources || blockedResources, !!_this.options.logRequests, USER_AGENT, function(blockedResources, logRequests, ua, resolve, reject) {
...
server._sendResponse = function(req, res, options) {
    ...
    if (req.prerender.resourcesData) {
        res.setHeader('X-OnCrawl-Resources-Timeline', JSON.stringify(req.prerender.resourcesData));
    }
